...
public class NoticeBookletWordServiceImpl implements NoticeBookletWordService {
    ...
    @Override
    public void generateWord(NoticeBooklet noticeBooklet) throws IOException {
        ...
        String wordPath = com.fiveup.core.noticeBooklet.utils.FileUtils.getPath(path, com.fiveup.core.noticeBooklet.utils.FileUtils.WORD_PATH);
