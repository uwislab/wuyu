...
public class UserPermissionController {
     ...
     */
    @PostMapping("/get")
    public Result<V> search(@RequestParam String userName, @RequestParam(required = false) Integer identity, @RequestParam String realName, @RequestParam Integer page, @RequestParam Integer pageSize){
    ...
    @PostMapping("/edit")
    public Result<V> edit(@RequestBody UserPermissionInfo userPermissionInfo){
